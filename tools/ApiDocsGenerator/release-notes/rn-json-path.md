...
order: "09.08"
---
# [1.1.6](https://github.com/gregsdennis/json-everything/pull/788) {#release-path-1.1.6}

[#797](https://github.com/gregsdennis/json-everything/issues/797) - ``.TryParse()`` does not respect `PathParsingOptions.AllowRelativeStart`.  Thanks to [@mikechristiansenvae](https://github.com/mikechristiansenvae) for reporting and fixing this.
