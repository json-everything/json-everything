...
order: "09.08"
---
# [3.0.2](https://github.com/json-everything/json-everything/pull/1013) {#release-path-3.0.2}

Updated nuget packages & EULA.

# [3.0.1](https://github.com/json-everything/json-everything/pull/995) {#release-path-3.0.1}
...
# [3.0.0](https://github.com/json-everything/json-everything/pull/982) {#release-path-3.0.0}

Enacted Open Source Maintenance Fee.

See the [blog post](https://blog.json-everything.net/posts/expensive/) for more information.

# [2.2.0](https://github.com/json-everything/json-everything/pull/952) {#release-path-2.2.0}

- Add .Net 10.0 support.
- Update Nuget references.

# [2.1.1](https://github.com/json-everything/json-everything/pull/866) {#release-path-2.1.1}
...
# [2.1.0](https://github.com/json-everything/json-everything/pull/848) {#release-path-2.1.0}
...
# [2.0.1](https://github.com/json-everything/json-everything/pull/842) {#release-path-2.0.1}

[#837](https://github.com/json-everything/json-everything/pull/837) - Support for nested nodelist functions.  Thanks to [@He-Pin](https://github.com/He-Pin) for reporting and fixing this.

# [2.0.0](https://github.com/json-everything/json-everything/pull/822) {#release-path-2.0.0}

- Add .Net 9.0 support.
- Remove `JsonResult.Error` (obsolete)
- [#821](https://github.com/json-everything/json-everything/issues/821) - Fix support for nodelist functions when used as an existence test.

# [1.1.6](https://github.com/json-everything/json-everything/pull/797) {#release-path-1.1.6}

[#797](https://github.com/json-everything/json-everything/pull/797) - `.TryParse()` does not respect `PathParsingOptions.AllowRelativeStart`.  Thanks to [@mikechristiansenvae](https://github.com/mikechristiansenvae) for reporting and fixing this.

# [1.1.5](https://github.com/json-everything/json-everything/pull/788) {#release-path-1.1.5}

[#787](https://github.com/json-everything/json-everything/issues/787) - `.TryParse()` would throw when encountering a `.`-selector at the end of the string.  Thanks to [@Nexiimil](https://github.com/Nexiimil) for reporting this.

# [1.1.4](https://github.com/json-everything/json-everything/pull/775) {#release-path-1.1.4}
...
# [1.1.3](https://github.com/json-everything/json-everything/pull/774) {#release-path-1.1.3}
...
# [1.1.2](https://github.com/json-everything/json-everything/pull/750) {#release-path-1.1.2}
...
# [1.1.1](https://github.com/json-everything/json-everything/pull/750) {#release-path-1.1.1}
...
# [1.1.0](https://github.com/json-everything/json-everything/pull/740) {#release-path-1.1.0}

[#738](https://github.com/json-everything/json-everything/issues/738) - Adds additional support for AOT and trimming.  Thanks to [@jevansaks](https://github.com/jevansaks) for implementing this update.

# [1.0.5](https://github.com/json-everything/json-everything/commit/3dac71f99ae3958482bfe9dc32e098a234a91c11) {#release-path-1.0.5}

An update to the test suite revealed an issue with the filter expression parser.

# [1.0.4](https://github.com/json-everything/json-everything/pull/731) {#release-path-1.0.4}

[#728](https://github.com/json-everything/json-everything/issues/728) - Failure to parse escaped single quote in single-quoted string in filter expressions.  Thanks to [@ashek-simeon](https://github.com/ashek-simeon) for reporting this.

# [1.0.3](https://github.com/json-everything/json-everything/pull/730) {#release-path-1.0.3}
...
# [1.0.2](https://github.com/json-everything/json-everything/pull/725) {#release-path-1.0.2}

Fixes a rare issue with `match()` and `search()` functions.

# [1.0.1.x](https://github.com/json-everything/json-everything/pull/712) {#release-path-1.0.1.x}
...
# [1.0.1](https://github.com/json-everything/json-everything/commit/550f4d97d52c90644cf033ae235fa6d80b3fbda3) {#release-path-1.0.1}

Fixed an issue around operator precedence in boolean expressions.

# [1.0.0](https://github.com/json-everything/json-everything/commit/550f4d97d52c90644cf033ae235fa6d80b3fbda3) {#release-path-1.0.0}

JSON Path RFC 9535 has been released!  (No functional changes from 0.8.0.)

# [0.8.1](https://github.com/json-everything/json-everything/pull/655) {#release-path-0.8.0}

[#653](https://github.com/json-everything/json-everything/pull/653) - [@Emcrank](https://github.com/Emcrank) applied modifications to support .Net Standard 2.0.

# [0.8.0](https://github.com/json-everything/json-everything/pull/619) {#release-path-0.8.0}
...
# [0.7.0](https://github.com/json-everything/json-everything/pull/591) {#release-path-0.7.0}

[#583](https://github.com/json-everything/json-everything/issues/583) - Updated `NodeList` to implement `IEnumerable<T>` instead of `IReadOnlyList<T>`, which enables follow-on Linq queries, making the entire JSON Path evaluation a deferred execution query.  Thanks to [@qt-kaneko](https://github.com/qt-kaneko) for explaining a use case that led to this change.
...
# [0.6.7](https://github.com/json-everything/json-everything/pull/526) {#release-path-0.6.7}
...
# [0.6.6](https://github.com/json-everything/json-everything/pull/524) {#release-path-0.6.6}

Adds support for `+` in number literals, e.g. `+24` and `1e+5`.

# [0.6.5](https://github.com/json-everything/json-everything/pull/515) {#release-path-0.6.5}
...
# [0.6.4](https://github.com/json-everything/json-everything/pull/496) {#release-path-0.6.4}

[#495](https://github.com/json-everything/json-everything/issues/495) - `.TryParse()` with empty string throws exception.  Thanks to [@ben-wckdrzr](https://github.com/ben-wckdrzr) for reporting this.

# [0.6.3](https://github.com/json-everything/json-everything/commit/2b6e2599e5513069cc1dbb3523d267d241966111) {#release-path-0.6.3}
...
# [0.6.2](https://github.com/json-everything/json-everything/pull/467) {#release-path-0.6.2}

[#465](https://github.com/json-everything/json-everything/issues/465) - Exposes more of the JSON Path object model, while making the exposed API more consistent.

# [0.6.1](https://github.com/json-everything/json-everything/pull/464) {#release-path-0.6.1}

[#463](https://github.com/json-everything/json-everything/issues/463) - Fixed implementation for string comparisons in filter expressions.  Thanks to [@idefy](https://github.com/idefy) for reporting this.

# [0.6.0](https://github.com/json-everything/json-everything/pull/459) {#release-path-0.6.0}
...
# [0.5.2](https://github.com/json-everything/json-everything/pull/431) {#release-path-0.5.2}

Improved support for regular expressions matching unicode text.

# [0.5.1](https://github.com/json-everything/json-everything/pull/412) {#release-path-0.5.1}
...
# [0.5.0](https://github.com/json-everything/json-everything/pull/407) {#release-path-0.5.0}
...
# [0.4.0](https://github.com/json-everything/json-everything/pull/372) {#release-path-0.4.0}
...
# [0.3.3](https://github.com/json-everything/json-everything/pull/367) {#release-path-0.3.3}
...
# [0.3.2](https://github.com/json-everything/json-everything/pull/366) {#release-path-0.3.2}

[#364](https://github.com/json-everything/json-everything/issues/364) - `count()`, `match()`, and `search()` functions are not registered and so cannot be parsed.  Thanks to [@amis92](https://github.com/amis92) for finding and reporting this.

# [0.3.1](https://github.com/json-everything/json-everything/commit/3248441c00dd97cf4a8c66fff6b2462682a3bb8e) {#release-path-0.3.1}

Fixed an issue in `search` and `match` function evaluation.

# [0.3.0](https://github.com/json-everything/json-everything/pull/362) {#release-path-0.3.0}

[#281](https://github.com/json-everything/json-everything/issues/281) - Complete rewrite to support `JsonNode` and align with specification.
[#351](https://github.com/json-everything/json-everything/issues/351) - Fixes issues parsing `$.['foo']` (basically removes support since the `.[]` syntax is invalid).
...
# [0.2.1](https://github.com/json-everything/json-everything/commit/1ba018b86c14dc94c55206062250735356491460) {#release-path-0.2.1}
...
# [0.2.0](https://github.com/json-everything/json-everything/pull/242) {#release-path-0.2.0}

Result locations should be expressed in Normalized Paths, not JSON Pointers.

# [0.1.14](https://github.com/json-everything/json-everything/pull/182) {#release-path-0.1.14}

Updated JsonPointer.Net to v2.0.0.  Please see [release notes](./json-pointer.md) for that library as it contains breaking changes.

# [0.1.13](https://github.com/json-everything/json-everything/pull/161) {#release-path-0.1.13}

Added experimential support for referencing data in secondary documents.

# [0.1.12](https://github.com/json-everything/json-everything/pull/161) {#release-path-0.1.12}

Added support for unary-not operator, e.g.

# [0.1.11](https://github.com/json-everything/json-everything/pull/159) {#release-path-0.1.11}

- Parenthetical support for nested expressions.
- Better stringifying.

# [0.1.10](https://github.com/json-everything/json-everything/pull/158) {#release-path-0.1.10}

Added support for comparisons against all JSON literals in expressions.

# [0.1.9](https://github.com/json-everything/json-everything/pull/155) {#release-path-0.1.9}

Better error reporting during parsing.

# [0.1.8](https://github.com/json-everything/json-everything/pull/150) {#release-path-0.1.8}

[#151](https://github.com/json-everything/json-everything/pull/151) - Parsing expressions with numeric values that contain `9` fails.

# [0.1.7](https://github.com/json-everything/json-everything/pull/133) {#release-path-0.1.7}
...
# [0.1.6](https://github.com/json-everything/json-everything/pull/122) {#release-path-0.1.6}

Updated expression parsing to handle whitespace better.

# [0.1.5](https://github.com/json-everything/json-everything/pull/75) {#release-path-0.1.5}

Added support for nullable reference types.

# [0.1.4](https://github.com/json-everything/json-everything/pull/61) {#release-path-0.1.4}
...
# [0.1.2](https://github.com/json-everything/json-everything/pull/45) {#release-path-0.1.2}

Added debug symbols to package.  No functional change.

# [0.1.1](https://github.com/json-everything/json-everything/pull/13) {#release-path-0.1.1}
