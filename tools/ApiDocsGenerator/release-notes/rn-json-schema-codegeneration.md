...
# [0.2.0](https://github.com/json-everything/json-everything/pull/619) {#release-schemacodegen-0.2.0}
...
# [0.1.3](https://github.com/json-everything/json-everything/pull/535) {#release-schemacodegen-0.1.3}

Added evaluation results from supported-pattern recognition process.

# [0.1.2](https://github.com/json-everything/json-everything/pull/509) {#release-schemacodegen-0.1.2}

Added support for `additionalProperties: false` to generate sealed classes.

# [0.1.1](https://github.com/json-everything/json-everything/pull/509) {#release-schemacodegen-0.1.1}
...
# [0.1.0](https://github.com/json-everything/json-everything/pull/505) {#release-schemacodegen-0.1.0}
