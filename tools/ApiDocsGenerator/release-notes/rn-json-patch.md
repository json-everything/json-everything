...
order: "09.09"
---
# [4.1.0](https://github.com/gregsdennis/json-everything/pull/###) {#release-patch-4.1.0}
...
- [#964](https://github.com/json-everything/json-everything/pull/970) - Patch size optimization for comparisons involving zero-length arrays by [@stephenmk](https://github.com/stephenmk)
