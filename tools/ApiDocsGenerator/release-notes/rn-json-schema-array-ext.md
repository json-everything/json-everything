...
order: "09.03"
---
# [4.0.1](https://github.com/json-everything/json-everything/pull/1013) {#release-schemaarrayext-4.0.1}

Updated nuget packages & EULA.

# [4.0.0](https://github.com/json-everything/json-everything/pull/982) {#release-schemaarrayext-4.0.0}

Enacted Open Source Maintenance Fee.

See the [blog post](https://blog.json-everything.net/posts/expensive/) for more information.

# [3.0.1](https://github.com/json-everything/json-everything/pull/959) {#release-schemaarrayext-3.0.1}

Performance improvements for `uniqueKeys`.

# [3.0.0](https://github.com/json-everything/json-everything/pull/822) {#release-schemaarrayext-3.0.0}
...
# [2.2.0](https://github.com/json-everything/json-everything/pull/822) {#release-schemaarrayext-2.2.0}

Add .Net 9.0 support.

# [2.1.0](https://github.com/json-everything/json-everything/pull/719) {#release-schemaarrayext-2.1.0}

Updated to use _JsonSchema.Net_ v7.0.0, which contains breaking changes ([release notes](/rn-json-schema/#release-schema-7.0.0)).

# [2.0.0.x](https://github.com/json-everything/json-everything/pull/712) {#release-schemaarrayext-2.0.0.x}
...
# [2.0.0](https://github.com/json-everything/json-everything/pull/619) {#release-schemaarrayext-2.0.0}
...
# [1.0.0](https://github.com/json-everything/json-everything/pull/120) {#release-schemaarrayext-1.0.0}
