...
{ 
	...
	public void Validate(JsonNode? template)
	{
		...
		if (parameter is JsonArray || parameter.TryGetTemplate(out _)) return;

		throw new TemplateException(IncorrectValueType(Name, "array"));
	}
	...
	public JsonNode? Evaluate(JsonNode? template, EvaluationContext context)
	{
		...
		var array = value.TryGetTemplate(out var t)
			? t!.Evaluate(context) as JsonArray ?? throw new TemplateException(IncorrectValueType(Name, "array"))
			: value.AsArray();
