...
public class BundlingTests
{
	...
	public void BundleMultipleDocuments()
	{
		...
		Console.WriteLine(JsonSerializer.Serialize(foo, TestEnvironment.SerializerOptionsUnsafeRelaxedEscaping));
		Console.WriteLine(JsonSerializer.Serialize(bar, TestEnvironment.SerializerOptionsUnsafeRelaxedEscaping));
		Console.WriteLine(JsonSerializer.Serialize(actual, TestEnvironment.SerializerOptionsUnsafeRelaxedEscaping));
	...
	public void BundleMultipleDocumentsMultipleRefs()
	{
		...
		Console.WriteLine(JsonSerializer.Serialize(foo, TestEnvironment.SerializerOptionsUnsafeRelaxedEscaping));
		Console.WriteLine(JsonSerializer.Serialize(bar, TestEnvironment.SerializerOptionsUnsafeRelaxedEscaping));
		Console.WriteLine(JsonSerializer.Serialize(baz, TestEnvironment.SerializerOptionsUnsafeRelaxedEscaping));
		Console.WriteLine(JsonSerializer.Serialize(actual, TestEnvironment.SerializerOptionsUnsafeRelaxedEscaping));
