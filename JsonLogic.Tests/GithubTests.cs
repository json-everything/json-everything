...
public class GithubTests
{
   ...
   ""data"": {
	...
	public void Issue183_RuleEvaluatesWrong2_Falsy()
	{
		...
		var rule = JsonSerializer.Deserialize(jsonRule, JsonLogicSerializerContext.Default.Rule);
	...
	{
		var rule = JsonSerializer.Deserialize("{ \"in\" : [ {\"var\": \"item\"}, {\"var\": \"list\"} ] }", JsonLogicSerializerContext.Default.Rule);
	...
	{
		var rule = JsonSerializer.Deserialize("{ \"+\" : [ 1, 2 ] }", JsonLogicSerializerContext.Default.Rule);
  ...
  ""=="": [
    ...
    null
		...
		var rule = node.Deserialize(JsonLogicSerializerContext.Default.Rule);
