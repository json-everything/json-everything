...
public class PatchExtensionTests
{
	...
	public void CreatePatch()
	{
		...
		Assert.AreEqual(patchExpected, JsonSerializer.Serialize(patch, PatchSerializerContext.Default.JsonPatch));
	}
	...
	public void Add()
	{
		...
		var expected = JsonSerializer.Deserialize(patchExpectedStr, PatchSerializerContext.Default.JsonPatch)!;
	...
	public void Remove()
	{
		...
		var patchExpected = JsonSerializer.Deserialize<JsonPatch>(patchExpectedStr, PatchSerializerContext.Default.JsonPatch)!;
	...
	public void ComplexObject()
	{
		...
		var patchBackExpected = JsonSerializer.Deserialize<JsonPatch>(patchBackExpectedStr, PatchSerializerContext.Default.JsonPatch);
	...
	public void ApplyPatch_Respect_SerializationOptions()
	{
		...
		var patch = JsonSerializer.Deserialize<JsonPatch>(patchStr, PatchSerializerContext.Default.JsonPatch)!;
	...
	public void CreatePatch_JsonContext()
	{
		...
		var patchJson = JsonSerializer.Serialize(patch, PatchSerializerContext.Default.JsonPatch);

		Assert.AreEqual(patchExpected, patchJson);
	}

	private static readonly JsonSerializerOptions _indentedSerializerOptions = new(PatchSerializerContext.Default.Options)
	{
		WriteIndented = true
	};
