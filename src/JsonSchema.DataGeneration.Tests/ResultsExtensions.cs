...
public static class ResultsExtensions
{
	...
	{
		Console.WriteLine(JsonSerializer.Serialize(results, TestHelpers.SerializerOptions));
	...
	private static void AssertEquivalent(EvaluationResults results, string? expected = null)
	{
		...
		var actualJson = JsonSerializer.SerializeToNode(results, TestHelpers.SerializerOptions);
