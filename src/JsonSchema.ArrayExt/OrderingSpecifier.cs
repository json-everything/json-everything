...
{
	/// <summary>
	/// Gets a pointerOld to the value.
	/// </summary>
	[JsonPropertyName("by")]
	public JsonPointer_Old By { get; }
	/// <summary>
	...
	/// </summary>
	/// <param name="by">A pointerOld to the value</param>
	...
	public OrderingSpecifier(JsonPointer_Old by, Direction direction = Direction.Ascending, CultureInfo? culture = null, bool ignoreCase = false)
	{
		By = by;
		Direction = direction;
