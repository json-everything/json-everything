...
/// </summary>
public class OptionalDataKeyword : IKeywordHandler
{
	/// <summary>
	/// Gets or sets the singleton instance of the <see cref="OptionalDataKeyword"/> class used for keyword operations.
	/// </summary>
	public static OptionalDataKeyword Instance { get; set; } = new();

	/// <summary>
	/// The JSON name of the keyword.
	/// </summary>
	public string Name => "optionalData";

	private OptionalDataKeyword()
	{
	}
