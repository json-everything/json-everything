...
{
	/// <summary>
	/// Gets the singleton instance of the <see cref="DescriptionKeyword"/>.
	/// </summary>
	public static DescriptionKeyword Instance { get; } = new();
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="DescriptionKeyword"/> class.
	/// </summary>
