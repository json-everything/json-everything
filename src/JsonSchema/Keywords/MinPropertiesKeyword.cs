...
{
	/// <summary>
	/// Gets the singleton instance of the <see cref="MinPropertiesKeyword"/>.
	/// </summary>
	public static MinPropertiesKeyword Instance { get; } = new();
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="MinPropertiesKeyword"/> class.
	/// </summary>
