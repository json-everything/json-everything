...
{
	/// <summary>
	/// Gets the singleton instance of the <see cref="MinimumKeyword"/>.
	/// </summary>
	public static MinimumKeyword Instance { get; } = new();
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="MinimumKeyword"/> class.
	/// </summary>
	protected MinimumKeyword()
	{
	}
