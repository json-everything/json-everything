...
{
	/// <summary>
	/// Gets the singleton instance of the <see cref="ExclusiveMaximumKeyword"/>.
	/// </summary>
	public static ExclusiveMaximumKeyword Instance { get; } = new();
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="ExclusiveMaximumKeyword"/> class.
	/// </summary>
