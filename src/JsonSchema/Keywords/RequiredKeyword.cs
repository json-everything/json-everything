...
{
	/// <summary>
	/// Gets the singleton instance of the <see cref="RequiredKeyword"/>.
	/// </summary>
	public static RequiredKeyword Instance { get; } = new();
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="RequiredKeyword"/> class.
	/// </summary>
