...
{
	/// <summary>
	/// Gets the singleton instance of the <see cref="ContentSchemaKeyword"/>.
	/// </summary>
	public static ContentSchemaKeyword Instance { get; } = new();
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="ContentSchemaKeyword"/> class.
	/// </summary>
