...
{
	/// <summary>
	/// Gets the singleton instance of the <see cref="PatternKeyword"/>.
	/// </summary>
	public static PatternKeyword Instance { get; } = new();
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="PatternKeyword"/> class.
	/// </summary>
