...
{
	/// <summary>
	/// Gets the singleton instance of the <see cref="DefinitionsKeyword"/>.
	/// </summary>
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="DefinitionsKeyword"/> class.
	/// </summary>
	protected DefinitionsKeyword()
	{
	}
