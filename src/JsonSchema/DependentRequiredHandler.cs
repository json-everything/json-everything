...
public sealed class DependentRequiredHandler : IKeywordHandler
{
    public void Build(
        JsonElement value,
    ...
    )
    {
        if (value.ValueKind != JsonValueKind.Object)
            throw new JsonSchemaException($"Invalid 'dependentRequired' keyword value: expected object, found {value.ValueKind}");
        ...
        constraints["dependentRequired"] = (instance, _) =>
        {
