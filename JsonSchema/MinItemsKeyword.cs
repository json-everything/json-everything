...
public class MinItemsKeyword : IJsonSchemaKeyword
{
	...
	private void Evaluator(KeywordEvaluation evaluation, EvaluationContext context)
	{
		...
		if (Value > number)
			evaluation.Results.Fail(Name, ErrorMessages.GetMinItems(context.Options.Culture).ReplaceToken("received", number).ReplaceToken("limit", Value));
	}
}
...
/// </summary>
public sealed class MinItemsKeywordJsonConverter : Json.More.AotCompatibleJsonConverter<MinItemsKeyword>
{
