...
public class RequiredKeyword : IJsonSchemaKeyword
{
	...
	private void Evaluator(KeywordEvaluation evaluation, EvaluationContext context)
	{
		...
		if (missing.Length != 0)
			evaluation.Results.Fail(Name, ErrorMessages.GetRequired(context.Options.Culture).ReplaceToken("missing", missing));
	}
}
...
/// </summary>
public sealed class RequiredKeywordJsonConverter : Json.More.AotCompatibleJsonConverter<RequiredKeyword>
{
