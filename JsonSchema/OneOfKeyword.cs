...
public class OneOfKeyword : IJsonSchemaKeyword, ISchemaCollector
{
	...
	private static void Evaluator(KeywordEvaluation evaluation, EvaluationContext context)
	{
		...
		if (actual != 1)
		{
			...
			evaluation.Results.Fail(Name, ErrorMessages.GetOneOf(context.Options.Culture).ReplaceToken("count", actual));
		}
	}
}
...
/// </summary>
public sealed class OneOfKeywordJsonConverter : Json.More.AotCompatibleJsonConverter<OneOfKeyword>
{
