...
public class MaximumKeyword : IJsonSchemaKeyword, IKeywordHandler
{
	public static MaximumKeyword Handler { get; } = new(0);
...
/// </summary>
public sealed class MaximumKeywordJsonConverter : WeaklyTypedJsonConverter<MaximumKeyword>
{
