...
/// </summary>
public sealed class PropertyDependencyJsonConverter : WeaklyTypedJsonConverter<PropertyDependency>
{
	...
	{
		var schemas = options.ReadDictionary(ref reader, JsonSchemaSerializerContext.Default.JsonSchema);
